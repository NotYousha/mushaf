...
export const ar: Strings = {
  ...
  pageN: (n: number | string) => `صفحة ${n}`,
  juzN: (n: string) => `الجزء ${n}`,
  paraN: (n: string) => `الجزء ${n}`,
  hizbN: (n: string) => `الحزب ${n}`,
  rubN: (n: string) => `الربع ${n}`,
  bookmark: 'حفظ الصفحة',
  bookmarks: 'الصفحات المحفوظة',
  noBookmarks: 'لا صفحات محفوظة بعد. افتح المصحف واضغط العلامة.',
  ...
  makki: 'مكية',
  madani: 'مدنية',
  ayahCount: (n: string) => `${n} آية`,
  continues: 'تتمة السورة',
  chooseMushaf: 'اختر المصحف',
  pickerHint: 'اضغط على مصحف لمعرفة المزيد.',
  familyUthmani: 'عثماني',
  familyTajweed: 'تجويد',
  familyIndoPak: 'هندي باكستاني',
  experimental: 'تجريبي',
  editionLive: 'نص حيّ — يُتابَع كلمة بكلمة، ويُبحَث فيه، ويُقرأ بصوت عالٍ.',
  editionGlyphs: 'رسم مطبوع — يُتابَع كلمة بكلمة، لكن لا يُبحَث فيه ولا يُقرأ بصوت عالٍ.',
  notYetHere: 'لم يُضَف بعد',
  unavailableWhy: {
    'no-source': 'لا يوجد مصدر عام له.',
    'needs-permission': 'النص متاح والخط ليس كذلك؛ يمنع توزيعه دون إذن مكتوب.',
    buildable: 'متاح ولم يُبنَ بعد: يحتاج تخطيطًا خاصًا و٦٠٤ خطوطًا للصفحات.',
  },
  mushafTab: 'المصحف',
  translationTab: 'الترجمة',
  translation: 'الترجمة',
  tafsirLabel: 'تفسير',
  playFromHere: 'التلاوة من هذه الآية',
  review: 'مراجعة',
  markClean: 'تمّت',
